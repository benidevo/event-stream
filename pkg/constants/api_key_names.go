...
// ApiKeyNames maps the API key numeric codes to their string representations
// as defined in the Kafka protocol specification.
...
// ApiKeys maps the API names to their numeric codes
// This is the reverse mapping of ApiKeyNames for convenience
var ApiKeys = map[string]int16{
	"Produce":                      0,
	"Fetch":                        1,
	"ListOffsets":                  2,
	"Metadata":                     3,
